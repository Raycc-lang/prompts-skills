...
**Target register:** a full example output at the length and tone to aim for lives
in `references/example-output.md`. Load it when calibrating register; the ordering
rules above are sufficient for routine use.
